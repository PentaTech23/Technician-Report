...
const InspectionReportCollectionRef = collection(formsDocRef, 'PROPERTY-TRANSFER-REPORT');
...
export default function FormsIRF() {
  ...
  const filteredData = fetchedData.filter((item) => {
    const fieldsToSearchIn = ['EntityName', 'FundCluster', 'PTRNum', 'ApprovedBy', 'ReleasedBy', 'ReceivedBy'];
  ...
  const handleConfirmDelete = async () => {
    try {
      if (documentToDelete) {
        ...
        await updateDoc(sourceDocumentRef, { archived: true, originalLocation: 'PROPERTY-TRANSFER-REPORT' });
        const sourceDocumentData = (await getDoc(sourceDocumentRef)).data();
 ...
 const handleOpenFilter = () => {
  ...
  return (
    <>
      <Helmet>
        <title> Property Transfer Report  Form | Minimal UI </title>
      </Helmet>
                  ...
                  <Grid container spacing={1} columns={8}>
                    ...
                    <Grid item xs={1}>
                      <TextField
                        ...
                        required
                        size="small"
                        value={formData.PTRNum || ''}
                        onChange={(e) => setFormData({ ...formData, PTRNum: e.target.value })}
                        sx={{ width: '100%', marginBottom: '10px' }}
                      />
                    </Grid>
                    <Grid item xs={1}>
              ...
              <TableBody>
                {displayedData.map((item, index) => (
                  <TableRow key={index}>
                    ...
                    <TableCell>{item.PTRNum}</TableCell>
              ...
              <Grid container spacing={1} columns={8}>
                    ...
                    <Grid item xs={1}>
                      <TextField
                        ...
                        required
                        size="small"
                        value={editData ? editData.PTRNum : ''}
                        onChange={(e) => setEditData({ ...editData, PTRNum: e.target.value })}
                        sx={{ width: '100%', marginBottom: '10px' }}
                      />
                    </Grid>
                    <Grid item xs={1}>
                        ...
                        >
                          ...
                          <Grid item xs={1}>
                            <TextField
                              ...
                              size="small"
                              value={
                                editData ? editData.inputField[index]?.Quantity : input?.Quantity 
                              }
                          ...
                          <Grid item xs={2}>
                            <TextField
                              ...
                              size="small"
                              value={
                                editData ? editData.inputField[index]?.PropertyNum : input?.PropertyNum 
                              }
                              onChange={(event) => handleEditChangeInput(index, event, 'PropertyNum')}
                            />
                            {/* Content for the third column */}
                          </Grid>
              ...
              <Grid container spacing={1} columns={8}>
                    ...
                    <Grid item xs={1}>
                      <TextField
                        ...
                        required
                        size="small"
                        value={viewItem ? viewItem.PTRNum : ''}
                        disabled
                        sx={{ width: '100%', marginBottom: '10px' }}
                      />
                    </Grid>
                 ...
                 >
                   ...
                   <Grid item xs={1}>
                     <TextField
                       ...
                       size="small"
                       value={
                        viewItem ? viewItem.inputField[index]?.Quantity : input?.Quantity 
                      }
                      disabled
                     />
                     {/* Content for the second column */}
                   ...
                   <Grid item xs={2}>
                     <TextField
                       ...
                       size="small"
                       value={
                        viewItem ? viewItem.inputField[index]?.PropertyNum : input?.PropertyNum 
                      }
                      disabled
                     />
                     {/* Content for the third column */}
